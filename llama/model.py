...
# This remove parellization of original code
...
class FeedForward(nn.Module):
    def __init__(
        ...
        self.w1 = loralib.Linear(
            dim, hidden_dim, bias=False, r=args.lora_r, lora_dropout=args.lora_dropout,)
        self.w2 = loralib.Linear(
            hidden_dim, dim, bias=False, r=args.lora_r, lora_dropout=args.lora_dropout,)
...
class Transformer(nn.Module):
    def __init__(self, params: ModelArgs):
        ...
        # self.tok_embeddings = loralib.Embedding(
        #     params.vocab_size, params.dim, r=params.lora_r)
        ...
        self.output = loralib.Linear(
            params.dim, params.vocab_size, bias=False, r=params.lora_r, lora_dropout=params.lora_dropout,)
